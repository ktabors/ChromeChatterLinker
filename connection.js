/*
Salesforce.com AJAX Connector 19.0
...
sforce.internal.Debug = function() {
    ...
    this.println = function(s, type) {
        ...
        if (this.win === null || !this.win.document) {
            this.output = null;
            this.win = window.open((typeof window.UserContext != "undefined") ? UserContext.getUrl('/soap/ajax/19.0/debugshell.html') : '/soap/ajax/19.0/debugshell.html', '',
...
sforce.Connection = function() {
    ...
    this.serverUrl = (typeof window.UserContext != "undefined") ? UserContext.getUrl("https://na7-api.salesforce.com/services/Soap/u/19.0") : "https://na7-api.salesforce.com/services/Soap/u/19.0";
};
...
sforce.connection.serverUrl = (typeof window.UserContext != "undefined") ? UserContext.getUrl("https://na7-api.salesforce.com/services/Soap/u/19.0") : "https://na7-api.salesforce.com/services/Soap/u/19.0";
